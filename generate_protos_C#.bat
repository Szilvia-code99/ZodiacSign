...
set GRPC_PATH=C:\Users\Yozmo\Desktop\vcpkg-master\installed\x86-windows\tools\grpc
set PROTOC_PATH=C:\Users\Yozmo\Desktop\vcpkg-master\installed\x86-windows\tools\protobuf
